 ...
 */
!function (a) {
    if ("function" == typeof define && define.amd) define(["leaflet"], a); else if ("undefined" != typeof module) module.exports = a(require("leaflet")); else {
    ...
    return a.Control.Search = a.Control.extend({
        ...
        cancel: function () {
            return this._input.value = "", this._handleKeypress({keyCode: 8}), this._input.size = this._inputMinSize, this._input.focus(), this._cancel.style.display = "none", this._hideTooltip(), this
        },
        expand: function (b) {
        ...
        _createInput: function (b, c) {
            var d = a.DomUtil.create("label", c, this._container), e = a.DomUtil.create("input", c, this._container);
        ...
        _defaultFormatData: function (c) {
            ...
            if (a.Util.isArray(f))for (d in c)g[b(c[d], e)] = a.latLng(c[d][f[0]], c[d][f[1]]); else for (d in c)g[b(c[d], e)] = a.latLng(b(c[d], f));
            return g
        },
        ...
        _recordsFromLayer: function () {
            ...
            return this._layer.eachLayer(function (f) {
                if (!f.hasOwnProperty("_isMarkerSearch"))if (f instanceof a.Marker || f instanceof a.CircleMarker)try {
                    if (b(f.options, e)) c = f.getLatLng(), c.layer = f, d[b(f.options, e)] = c; else {
        ...
        _autoType: function () {
            var a = this._input.value.length, b = this._tooltip.firstChild._text, c = b.length;
        ...
        _hideAutoType: function () {
            var a;
            if ((a = this._input.selection) && a.empty) a.empty(); else if (this._input.createTextRange) {
        ...
        searchText: function (b) {
            ...
            this._input.value = b, this._input.style.display = "block", a.DomUtil.addClass(this._container, "search-exp"), this._autoTypeTmp = !1, this._handleKeypress({keyCode: c})
        },
        ...
        _handleArrowSelect: function (b) {
            ...
            if (1 == b && this._tooltip.currentSelection >= c.length - 1) a.DomUtil.addClass(c[this._tooltip.currentSelection], "search-tip-select"); else if (-1 == b && this._tooltip.currentSelection <= 0) this._tooltip.currentSelection = -1; else if ("none" != this._tooltip.style.display) {
        ...
        _handleSubmit: function () {
            if (this._hideAutoType(), this.hideAlert(), this._hideTooltip(), "none" == this._input.style.display) this.expand(); else if ("" === this._input.value) this.collapse(); else {
        ...
        animate: function () {
            if (this._circleLoc) {
                var a = this._circleLoc, b = 200, c = 5, d = parseInt(a._radius / c), e = this.options.circle.radius, f = 2 * a._radius, g = 0;
